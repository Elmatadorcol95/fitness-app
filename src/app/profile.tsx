      ...
      <SafeAreaView style={styles.safe}>
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
          ...
          <View style={sectionStyles.wrap}>
            <View style={styles.equipHeader}>
              <ThemedText style={sectionStyles.title}>
                {t('tabs.profile.exercisePreferencesSection')}
              </ThemedText>
              <Pressable
                onPress={() => useProfileStore.getState().openExercisePreferences()}
                style={styles.editEquipBtn}
                hitSlop={8}
              >
                <Ionicons name="create-outline" size={15} color="#3FBF7F" />
                <ThemedText style={styles.editEquipText}>{t('exercisePreferences.editBtn')}</ThemedText>
              </Pressable>
            </View>
            <ThemedView type="backgroundElement" style={sectionStyles.card}>
              <ThemedText themeColor="textSecondary" style={styles.gymEquipNote}>
                {t('exercisePreferences.summary')}
              </ThemedText>
            </ThemedView>
          </View>
